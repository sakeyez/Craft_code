...
export default defineConfig({
  ...
  test: {
    ...
    // apps/cli only, not apps/*: apps/desktop/renderer/tests/*.e2e.ts needs the built
    // frontend dist and runs under vitest.desktop-renderer.config.ts (the test:desktop-renderer job).
