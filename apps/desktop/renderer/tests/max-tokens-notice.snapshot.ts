...
// client.js` bundles through RendererBootEntry's ModuleLoader path against the
...
const EXPECTED = join(process.cwd(), 'apps/desktop/renderer/tests/snapshots/max-tokens-notice/history-turn.expected.txt')
