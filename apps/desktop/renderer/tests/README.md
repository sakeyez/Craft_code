# apps/desktop/renderer browser e2e
...
the deliberate composition divergences from `dsh desktop` — are documented in
...
it imports `RendererBootEntry` from `@deepseek-ai/dsh-client-web` and the boot-manifest
