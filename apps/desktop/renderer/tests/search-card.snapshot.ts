...
// through RendererBootEntry's ModuleLoader path against the keyless
...
const EXPECTED = join(process.cwd(), 'apps/desktop/renderer/tests/snapshots/search-card/grep-card.expected.txt')
