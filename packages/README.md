...
| [`minecraft/`](minecraft/README.md) | Minecraft-domain agent packages, including Fabric-first mod-development prompt guidance and project detection | Product — stable API |
