...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Session-scoped external-game companion controls; absent when no game is active.',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Optional application chrome above the three-column body.',
    doc: 'Optional application chrome above the three-column body. An absent\noccupant consumes no height; desktop hosts can contribute their own\nmenu bar without changing the browser composition.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
