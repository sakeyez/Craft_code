...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Session-scoped external-game status and annotation entry; absent when no game is active.',
    doc: 'Session-scoped external-game status and annotation entry; absent when no game is active.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-layout GameWorkspace',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'game\', () => ctx.slots.register(\n      { name: \'game\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-mcmod-workbench NetworkSettings id \'minecraft-network\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-desktop-menu DesktopMenuSurface id \'desktop-menu\'',
      'client-ui-mcmod-bootstrap BootstrapOverlay id \'mcmod-bootstrap-overlay\'',
      'client-ui-mcmod-workbench WorkbenchDialogs id \'minecraft-project-dialogs\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Optional application menus at the leading edge of the topbar.',
    doc: 'Optional application menus at the leading edge of the topbar. An absent\noccupant consumes no space; project navigation follows in the same row.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-desktop-menu DesktopMenuBar',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'shell.window-controls',
    kind: 'single',
    scope: 'root',
    summary: 'Optional trailing window controls; the host also owns their draggable title-bar space.',
    doc: 'Optional trailing window controls; the host also owns their draggable title-bar space.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-desktop-menu DesktopWindowControls',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'sidebar.primary.action',
    kind: 'single',
    scope: 'root',
    summary: 'Primary project action rendered above the workspace browser.',
    doc: 'Primary project action rendered above the workspace browser.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mcmod-bootstrap BootstrapAction',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Topbar project navigation receives cwd, optional session and selected view.',
    doc: 'Topbar project navigation receives cwd, optional session and selected view.\nA registration replaces the navigation occupant; absence consumes no height.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mcmod-workbench WorkbenchNavigation',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'workbench.nav\', () => ctx.slots.register(\n      { name: \'workbench.nav\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-layout/src/client/index.ts:42',
  },
  {
    key: 'workbench.panel',
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Project tool panel receives cwd, optional session and selected view.',
    doc: 'Project tool panel receives cwd, optional session and selected view.\nA registration replaces the tool occupant; absence leaves an empty tool area.',
    registerOptions: [],
    ownerProps: [
      '/** Conversation owner share: business state and actions belong to the registrant. */\nexport interface WorkbenchOwnerProps { cwd: string; view: \'conversation\' | \'code\' | \'dependencies\' | \'test\' }',
    ],
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mcmod-workbench WorkbenchPanel',
    ],
    replaceRisk: 'shadows-shipped-ui',
