 ...
 * data. Its shell-backed check runner delegates process execution to the
 * mounted shell service, while the tool registry owns schema validation, scoped
 * registration, execution, presentation, and disposal.
 */
