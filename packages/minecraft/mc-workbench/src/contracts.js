...
export const workbenchIdSchema = z.uuid().transform(value => value);
...
const projectSchema = z.object({
    ...
    modIdCandidates: z.array(z.object({ id: z.string(), source: z.string(), confidence: z.enum(['high', 'medium', 'low']) })),
...
const responseSchemas = {
    ...
    'resource-preview': z.object({
        ...
        elements: z
            ...
            faces: z.record(z.string(), z.object({
                texture: z.string(),
 ...
 */
export function parseWorkbenchResponse(endpoint, value) {
    const schema = responseSchemas[endpoint];
    if (!schema)
        throw new Error('未知工作台响应类型。');
