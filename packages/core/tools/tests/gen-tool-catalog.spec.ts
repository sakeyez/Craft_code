...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'cordis_undefine', 'create_goal', 'detect_mc_project', 'edit', 'exit_plan_mode', 'followup_task', 'get_goal', 'glob', 'grep',
      'interrupt_agent', 'interrupt_agent', 'job_kill', 'job_list', 'job_output',
      'list_agents', 'list_agents', 'lsp', 'pwsh', 'pwsh', 'ralph',
      'read', 'read_image', 'report', 'run_code', 'run_mc_check', 'schedule_create', 'schedule_delete',
      ...
      'update_goal', 'validate_mc_resources', 'wait_agent', 'web_fetch', 'web_search', 'workflow', 'write',
    ])
