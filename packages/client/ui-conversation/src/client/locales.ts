...
export const zh = {
  ...
  'placeholder.hero': '描述你想打造的内容',
  'placeholder.workspace': '选择工作区开始打造',
  'input.commands': '命令',
  'input.stop': '停止生成',
  'input.send': '发送消息',
...
export const en = {
  ...
  'placeholder.hero': 'Describe what you want to craft',
  'placeholder.workspace': 'Choose a workspace to craft',
  ...
  'hero.headline': 'Craft a new idea',
