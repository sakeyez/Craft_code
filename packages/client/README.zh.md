# client/ — 桌面 renderer 客户端

[English](README.md) | 中文

dsh 桌面应用的 renderer 侧：shell 启动、宿主通信、共享 UI 服务和功能插件。编写规则见 [AGENTS.md](AGENTS.md)；宿主半侧是 [`host/`](../host/README.zh.md)。除 `test-runtime` 外，均为名为 `@deepseek-ai/dsh-client-<name>` 的**产品**包。
