...
- **外部游戏跟踪依赖桌面宿主**：浏览器会话不会获得特权游戏窗口操作，非 Windows 桌面宿主也会保持普通布局。
