...
[`dsh-base`](../packages/bundle/base/README.zh.md) 是每个 profile 的第一层：模型适配器、工具、持久化、沙箱与审批策略、设置、凭据、遥测。[`dsh-web-app`](../packages/bundle/web-app/README.zh.md) 增加浏览器应用；[`dsh-headless`](../packages/bundle/headless/README.zh.md) 增加一次性运行器，且完全不带服务器。[`dsh-mcmod-headless-bundle`](../packages/bundle/mcmod-headless/README.zh.md) 将该 headless runner 专门化为 Fabric-first Minecraft 模组开发任务入口。
