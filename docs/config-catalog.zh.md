...
来源：[`packages/core/agent-loop/src/index.ts:289`](../packages/core/agent-loop/src/index.ts)
...
来源：[`packages/bundle/desktop-app/src/index.ts:32`](../packages/bundle/desktop-app/src/index.ts)
...
来源：[`packages/minecraft/tool-mc-project/src/index.ts:68`](../packages/minecraft/tool-mc-project/src/index.ts)
...
- `@deepseek-ai/dsh-client-ui-desktop-menu`（[`packages/client/ui-desktop-menu/src/index.ts`](../packages/client/ui-desktop-menu/src/index.ts)）
...
- `@deepseek-ai/dsh-mc-workbench` — 需要 `fs` · `subprocess` ([`packages/minecraft/mc-workbench/src/index.ts`](../packages/minecraft/mc-workbench/src/index.ts))
