...
| `tsconfig.client.json` | Client aggregate: `packages/client/*` packages and their tests, `apps/desktop/renderer`, and the exceptional Client project of `api/remotes`. | Yes |
