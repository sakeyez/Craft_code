...
```sh
dsh desktop --patch "$PWD/examples/mcp-memory/memorix.cordis.yml"
```
...
dsh desktop --patch "$PWD/examples/mcp-memory/mcp-reference-memory.cordis.yml"
```
...
dsh desktop --patch "$PWD/examples/mcp-memory/engram.cordis.yml"
```
