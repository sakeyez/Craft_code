...
This overlay opts one `dsh desktop` process into Schedule reminders without changing the shipped default Web composition:

```sh
dsh desktop --patch examples/web-schedule/cordis.yml
```
