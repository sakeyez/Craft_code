...
const serialFiles = [
  'apps/desktop/renderer/tests/hmr-live.e2e.ts',
  'apps/desktop/renderer/tests/cordis-tool-round.e2e.ts',
]
...
const invocation = pnpmInvocation(['exec', 'vitest', 'run', '--config', 'vitest.desktop-renderer.config.ts'])
let serialStatus = 0
